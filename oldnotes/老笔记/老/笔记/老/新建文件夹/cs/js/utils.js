 ...
 *    // 当天00点00分00秒
 *    // var timestamp = new Date(new Date(new Date().toLocaleDateString()).getTime());
 *    // 当天23点59分59秒
 *    // var timestamp = new Date(new Date(new Date().toLocaleDateString()).getTime()+24*60*60*1000-1);  
 *    // 次日的00点00分00秒
 *    // var timestamp = new Date(new Date(new Date().toLocaleDateString()).getTime()+24*60*60*1000);
 *    // 前一天的00点00分00秒
 *    // var timestamp = new Date(new Date(new Date().toLocaleDateString()).getTime()-24*60*60*1000);
 * 
 *    // timestampToTime(timestamp);
 *    // 输出格式 2019-11-21 17:59:29
 *    // timestampToDate(timestamp);
 *    // 输出格式 2019-11-21
 */
myUtils.prototype.timestampToDate = function (timestamp) {
...
myUtils.prototype.timestampToTime = function (timestamp) {
    var date = new Date(timestamp);
    var yy = date.getFullYear() + '-';
    var mm = (date.getMonth() + 1 < 10 ? '0' + (date.getMonth() + 1) : date.getMonth() + 1) + '-';
    var dd = (date.getDate() < 10 ? '0' + (date.getDate()) : date.getDate());
    var hh = (date.getHours() < 10 ? '0' + (date.getHours()) : date.getHours()) + ':';
    var mms = (date.getMinutes() < 10 ? '0' + (date.getMinutes()) : date.getMinutes()) + ':';
